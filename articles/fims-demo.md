...
```
    ...
    ## ℹ Total run time was 57.59119 seconds
...
```
    ...
    ##                  timestamp   level
    ## 1 Mon Jul 27 13:15:49 2026 warning
    ##                                                                   message id
...
```
    ...
    ##                  timestamp   level
    ## 1 Mon Jul 27 13:15:49 2026 warning
    ## 2 Mon Jul 27 13:15:49 2026 warning
    ##                                                                   message id
    ## 1 The log_f_multiplier vector is not of size n_years. Filling with zeros.  0
...
```
    ...
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.9.3.9000
    ## ℹ Total run time was 58.12891 seconds
    ## ℹ Number of parameters: fixed_effects=49, random_effects=29, and total=78
...
```
    ...
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.9.3.9000
    ## ℹ Total run time was 59.03196 seconds
    ## ℹ Number of parameters: fixed_effects=49, random_effects=29, and total=78
...
```
    ...
    ## ✔ Finished optimization
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.9.3.9000 ℹ Total run time was 8.86545 seconds ℹ Number
...
```
    ...
    ## ✔ Finished optimization
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.9.3.9000 ℹ Total run time was 56.37021 seconds ℹ Number
    ## of parameters: fixed_effects=49, random_effects=29, and total=78 ℹ Maximum
