...
```
    ...
    ## function (x, y, z) 
    ## .Call(<pointer: 0x7f39193283f0>, x, y, z)
...
```
    ...
    ##   mean(x) 398.735 430.2085 436.9747 436.2150 443.373   503.02   100
    ##  meanC(x)  94.166  94.5420 199.6513  94.9225  95.584 10396.30   100
